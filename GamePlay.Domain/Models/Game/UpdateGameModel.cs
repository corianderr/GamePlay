...
public class UpdateGameModel
{
    ...
    [Range(1, 100, ErrorMessage = "Min play time value must be between 1 and 100")]
    [Required(ErrorMessage = "Please enter minimum play time in minutes.")]
    [DisplayName("Minimum play time in minutes")]
    public int MinPlayTime { get; set; }
    [Range(1, 100, ErrorMessage = "Max play time value must be between 1 and 100")]
    ...
    [YearRange(1800, ErrorMessage = "You definitely messed something up. Games in such a distant past have not yet been released. Enter a year between 1800 and the current year.")]
